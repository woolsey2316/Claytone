...
export type Blog_By_SlugQuery = { __typename?: 'Query', blogPost: { __typename?: 'BlogPost', title: string, imageurl: string, createdAt: string, updatedAt: string, slug: string, excerpt: string, featuredPost: boolean, content: string, author: { __typename?: 'Author', username: string } } };

export type BlogsQueryVariables = Exact<{ [key: string]: never; }>;


export type BlogsQuery = { __typename?: 'Query', blogPosts: Array<{ __typename?: 'BlogPost', title: string, imageurl: string, createdAt: string, updatedAt: string, slug: string, excerpt: string, featuredPost: boolean, content: string, author: { __typename?: 'Author', username: string } }> };
