...
import TriangleUp from '@/components/svg/TriangleUp';
  ...
  return (
    <div className="mb-5" id="accordion">         
      <div className="mb-0 border border-grey4">
        <div className="py-[10px] px-15px text-grey5 border-0 border-grey4 border-b-[1px]">
          <h4 className="my-0 font-medium capitalize">
            <a href="#collapse-coupon" className="text-coral" data-toggle="collapse" data-parent="#accordion" aria-expanded="true">
              Use Coupon Code
            </a>
            {open[0] ? <TriangleDown setOpen={setOpen} index={0} /> : <TriangleUp setOpen={setOpen} index={0}/>}
          </h4>
        </div>
        <div id="collapse-coupon" className={`transition-height text-sm text-black2 ${open[0] ? 'h-0 hidden': ''}`} aria-expanded="true">
          <div className="p-[15px]">
            <label className="w-[16.6%] px-15px text-[15px] mb-[5px] control-label float-left" htmlFor="input-coupon">Enter your coupon here</label>
      ...
      <div className="mt-15px rounded-none mb-0 border border-grey4">
        <div className="py-[10px] px-15px text-grey5 border-0 border-b-[1px] border-grey4">
          <h4 className="font-medium capitalize">
            ...
            {open[1] ? <TriangleDown setOpen={setOpen} index={1} /> : <TriangleUp setOpen={setOpen} index={1}/>}
          </h4>
        </div>
        <div id="collapse-shipping" className={`transition-height text-sm text-black2 ${open[1] ? 'h-0 hidden': ''}`} aria-expanded="false">
          <div className="p-15px">
            ...
            <div className="">
              ...
              <div className="mx--15px mb-5 ">
                ...
                <div className="md:w-[83.33%] relative minh-h-[1px] px-15px">
                  <input type="text" name="postcode" value="" placeholder="Post Code" id="input-postcode" className="text-sm h-[34px] block w-full py-[5px] px-15px leading-[20px] text-grey2 rounded-[5px]"/>
                </div>
              </div>
              <button type="button" id="button-quote" data-loading-text="Loading..." className="py-[7px] px-5 inline-block text-sm text-white uppercase bg-coral rounded-[5px] border-none relative leading-[20px]">Get Quotes</button>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="mt-15px mb-0 border border-grey3 ">
        <div className="text-grey5 border-grey3 border-b-0 px-[10px] p-15px">
          <h4 className="my-0 font-medium">
            ...
            {open[2] ? <TriangleDown setOpen={setOpen} index={2} /> : <TriangleUp setOpen={setOpen} index={2}/>}
          </h4>
        </div>
        <div id="collapse-voucher" className={`transition-height text-sm text-black2 ${open[2] ? 'h-0 hidden': ''}`} aria-expanded="false">
          <div className="border-t border-t-grey3 p-15px table w-full">
            <label className="float-left inline-block md:w-[16.66%] relative min-h-[1px] px-15px text-[15px] mb-[5px]" htmlFor="input-voucher">Enter your gift certificate code here</label>
            <div className="relative table border-separate">
              <input type="text" name="voucher" value="" placeholder="Enter your gift certificate code here" id="input-voucher" className="rounded-tr-none rounded-br-none text-sm table-cell relative z-[2] w-full mb-0 float-left"/>
              <span className="relative whitespace-nowrap w-[1%] table-cell border-separate align-middle">
                <input type="submit" value="Apply Gift Certificate" id="button-voucher" data-loading-text="Loading..." className="z-[2] ml-[-1px] py-[7px] px-[20px] rounded-tl-none rounded-bl-none relative text-14px bg-coral text-white cursor-pointer"/>
              </span> 
            </div>
          </div>
        </div>
